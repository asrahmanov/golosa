...
@section('content')
    ...
    <section class="opening-hero">
        <div class="opening-hero-content fade-in">
            ...
            <div class="opening-date">
                ...
                <span class="opening-date-month">января 2026</span>
            ...
            <div class="opening-location">
                ...
                Территория развития «Гранд Каньон», 3 этаж, «Дивный город»<br>
    ...
    <section class="venue-section container fade-in">
        ...
        <p class="section-subtitle" style="text-align: center;">Территория развития «Гранд Каньон», 3 этаж, «Дивный город»</p>

        <div class="venue-grid">
            <div class="venue-image">
                <img src="{{ asset('img/grand/photo_2025-12-21 20.41.12.jpeg') }}" alt="Территория развития Гранд Каньон">
            </div>
            <div class="venue-image">
                <img src="{{ asset('img/grand/photo_2025-12-21 20.41.16.jpeg') }}" alt="Территория развития Гранд Каньон">
            </div>
            <div class="venue-image">
                <img src="{{ asset('img/grand/61864015.jpeg') }}" alt="Территория развития Гранд Каньон">
            </div>
            <div class="venue-image">
                <img src="{{ asset('img/grand/photo_2025-12-21 20.41.24.jpeg') }}" alt="Территория развития Гранд Каньон">
            </div>
        </div>
    </section>
    ...
    <section class="cta-section container fade-in">
        <div class="cta-card">
            ...
            <div class="cta-location-big">Территория развития «Гранд Каньон», 3 этаж, «Дивный город»<br>пр-т. Энгельса, 154, Санкт-Петербург</div>
